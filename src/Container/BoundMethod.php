...
class BoundMethod
{
     ...
     * @return mixed
     *
     * @throws InvalidArgumentException|BindingResolutionException|CircularDependencyException|ReflectionException
     */
     ...
     * @return void
     *
     * @throws BindingResolutionException|BindingResolutionException|CircularDependencyException|ReflectionException
     */
                                                            ...
                                                            array     &$parameters, array &$dependencies)
    {
        ...
        } elseif (!is_null($className = Utilities::getParameterClassName($parameter))) {
